...
- **`_meta_job_ref`** — the next sequential quote reference. **The current next reference is `FR-CB-004`.** Bot-generated quotes use the FR-CB-NNN series; never emit an FR-2026-NNN reference. Also write this same value into `QUOTE_REF` in the HTML.
